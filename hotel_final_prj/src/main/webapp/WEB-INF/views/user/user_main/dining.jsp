				...
				<table class="diningTab">
					<tr>
						<td>
							<div class="diningImg">
								<a href="#void"><img
									src="http://211.63.89.141/user/main_images/dining01.jpg"
						...
						<td>
							<div class="diningImg">
								<a href="#void"><img
									src="http://211.63.89.141/user/main_images/dining02.jpg"
									width="480" height="300"></a><br />
							</div>
							<div class="diningBox">
								<span class="rstr">레스토랑</span><br /> <a href="#void"><span
					...
					<tr>
						<td>
							<div class="diningImg">
								<a href="#void"><img
									src="http://211.63.89.141/user/main_images/dining03.jpg"
									width="480" height="300"></a><br />
							</div>
							<div class="diningBox">
						...
						<td>
							<div class="diningImg">
								<a href="#void"><img
									src="http://211.63.89.141/user/main_images/dining04.jpg"
									width="480" height="300"></a><br />
							</div>
							<div class="diningBox">
					...
					<tr>
						<td>
							<div class="diningImg">
								<a href="#void"><img
									src="http://211.63.89.141/user/main_images/dining05.jpg"
									width="480" height="300"></a><br />
							</div>
							<div class="diningBox">
								<span class="rstr">바 & 라운지</span><br /> <a href="#void"><span
						...
						<td>
							<div class="diningImg">
								<a href="#void"><img
									src="http://211.63.89.141/user/main_images/dining06.jpg"
									width="480" height="300"></a><br />
							</div>
							<div class="diningBox">
